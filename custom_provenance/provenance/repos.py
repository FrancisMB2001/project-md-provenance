...
def _process_info():
    ...
    #######
    ####### This was added by fansoncraaiv, até ao return (as 8 proximas linhas de codigo), e o num_fds no return
    #######
    ...
    if platform.system() != "Windows":
        ...
        num_fds = len(p.net_connections())  # Count open network connections
